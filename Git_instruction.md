...
8. При слиянии веток с разной информацией `Git` сообщит о конфликте и предложет выбрать какие изменения необходимо записать. Для этого в ручную в подсвеченых вариантах выбираем, что необходимо оставить, остальное удаляем и принимаем слияние.
